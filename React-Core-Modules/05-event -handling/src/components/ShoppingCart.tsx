...
class ShoppingCart extends React.Component<IProps, IState> {
  ...
  incrQty = (sno: string) => {
    let incrProducts: IProduct[] = this.state.products.map(
      (product: IProduct) => {
        if (product.sno === sno) {
          return {
            ...product,
  ...
  decrQty = (sno: string) => {
    let decrProducts: IProduct[] = this.state.products.map(
      (product: IProduct) => {
        if (product.sno === sno) {
          return {
            ...product,
                      ...
                      <tr key={product.sno}>
                        ...
                        <td>
                          <i
                            ...
                            onClick={this.decrQty.bind(this, product.sno)}
                          />
                          {product.qty}
                          <i
                            className="fa fa-plus-circle mx-1"
                            onClick={this.incrQty.bind(this, product.sno)}
                          />
                        </td>
